...
class WindowController: NSWindowController, NSWindowDelegate {
	...
	func window(window: NSWindow, willUseFullScreenPresentationOptions proposedOptions: NSApplicationPresentationOptions) -> NSApplicationPresentationOptions {
		return NSApplicationPresentationOptions.AutoHideToolbar.union(NSApplicationPresentationOptions.AutoHideMenuBar).union(NSApplicationPresentationOptions.FullScreen).union(proposedOptions)
	}
